...
public class NodeUsagesFinderTest
{
    ...
    @Test
    public void Should_Throw_Exception_When_Parameters_Are_Null()
    {
        // given
    ...
    @Test
    public void Should_Find_No_Usages_When_There_Are_No_Selected_Nodes()
    {
        // given
    ...
    @Test
    public void Should_Find_Usages_If_Node_Is_Used()
    {
        // given
        allNodes.add(firstNode);
    ...
    @Test
    public void Should_Find_No_Usages_If_Node_Is_Not_Used()
    {
        // given
        allNodes.add(firstNode);
        allNodes.add(secondNode);
